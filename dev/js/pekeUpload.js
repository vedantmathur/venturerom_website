...
(function($) {
  ...
  $.fn.pekeUpload = function(options){
    ...
    function UploadFile(){
      var error = true;
      if (options.theme=="bootstrap"){
        var htmlprogress = '<div class="file"><div class="filename"></div><div class="progress progress-striped active"><div class="bar pekeup-progress-bar progress-bar progress-bar-success" style="width: 0%;"><span class="badge badge-info"></span></div></div></div>';
      }
      if (options.theme=="custom"){
